...
Les groupes pushent dans ce répertoire (tous les groupes ont le code de l'ensemble des groupes). Les issues sont créées avec un lien vers un déport par projet (hors Daisee) ; chaque groupe est autonome (notamment sur les process de MAJ).
